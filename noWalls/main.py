...
from environment.mazeMA import MazeMA as MazeMA
from models import *
from models.qtable_regular import *
from models.qtable_medianMA import *
...
num_agents = 2
game = MazeMA(maze, num_agents=num_agents)
# maze.draw()
...
for k, km in zip(ks, kms):
    print("k = " + str(k))
    print("km = " + str(km))
    model = QTableModel_medianMA(game, name="QTableModel", num_agents=num_agents)
